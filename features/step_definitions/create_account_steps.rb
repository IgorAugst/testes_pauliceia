...
And(/^I uncheck receive email notification$/) do
  find(:xpath, '/html/body/div/section/div/div/section/div[1]/div[1]/form/div[3]/label[1]/span[1]', visible: false).set(false)
end
